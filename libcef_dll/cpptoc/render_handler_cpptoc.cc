...
//
// $hash=db909c8b6b42fa6aa86bfc091f206c3062427efb$
//
...
void CEF_CALLBACK render_handler_on_accelerated_paint_surface_retired(
  ...
  // Execute
  CefRenderHandlerCppToC::Get(self)->OnAcceleratedPaintSurfaceRetired(
      CefBrowserCToCpp_Wrap(browser), pool_surface_id);
}
...
#if CEF_API_ADDED(CEF_EXPERIMENTAL)
  GetStruct()->on_accelerated_paint_surface_retired =
      render_handler_on_accelerated_paint_surface_retired;
#endif
}
